...
import { BasicLink, ImageLoader, ThemeSwitcher } from '@/components/Essentials'
...
export default function Home() {
  ...
  const pageTitle = `${siteMeta.defaultTitle} - ${siteMeta.description}`

  return (
    <Layout fullTitle={pageTitle} withHeader withFooter animate>
